...
Do_Something_With_Result:
    ...
    ;T_MAX;
    load_y(300) ; Assuming a max temperature of 300 degrees celsius above ambient
    lcall mul32
    ;*****;

    ;V_ref;
    load_y(4096) ; Vref = 4.096 volts
    lcall mul32
    load_y(1000)
    lcall div32
    ;*****;
    ...
    ;1023;
    load_y(1023) ; divide by constant 1023
    lcall div32
    ;****;

    ;T_ambient;
    load_y(22) ; adding the ambient temp to our reading
    lcall add32
    ;*********;
